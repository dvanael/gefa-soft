...
class Funcionario(models.Model):
    ...
    preco_trabalho = models.DecimalField(verbose_name="Preço do Trabalho", max_digits=5, decimal_places=2, null=False, default=0.00)
...
class Producao(models.Model):
    ...
    quantidade = models.DecimalField(verbose_name="Quantidade", max_digits=5, decimal_places=2, null=False)
